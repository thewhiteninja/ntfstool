...
{
	std::vector<std::string> ret;
	if (f & CERT_SET_KEY_CONTEXT_PROP_ID) ret.push_back("CERT_SET_KEY_CONTEXT_PROP_ID");
...
std::string constants::efs::cert_prop_id(DWORD p)
{
	switch (p)
	{
	case CERT_CERTIFICATE_FILE: return "CERT_CERTIFICATE_FILE";
	case CERT_CERTIFICATE_REVOCATION_LIST: return "CERT_CERTIFICATE_REVOCATION_LIST";
	case CERT_CERTIFICATE_TRUST_LIST: return "CERT_CERTIFICATE_TRUST_LIST";
	case CERT_KEY_ID: return "CERT_KEY_ID";
	case CERT_KEY_PROV_HANDLE_PROP_ID: return "CERT_KEY_PROV_HANDLE_PROP_ID";
	case CERT_KEY_PROV_INFO_PROP_ID: return "CERT_KEY_PROV_INFO_PROP_ID";
	case CERT_SHA1_HASH_PROP_ID: return "CERT_SHA1_HASH_PROP_ID";
	case CERT_MD5_HASH_PROP_ID: return "CERT_MD5_HASH_PROP_ID";
	case CERT_KEY_CONTEXT_PROP_ID: return "CERT_KEY_CONTEXT_PROP_ID";
	case CERT_KEY_SPEC_PROP_ID: return "CERT_KEY_SPEC_PROP_ID";
	case CERT_IE30_RESERVED_PROP_ID: return "CERT_IE30_RESERVED_PROP_ID";
	case CERT_PUBKEY_HASH_RESERVED_PROP_ID: return "CERT_PUBKEY_HASH_RESERVED_PROP_ID";
	case CERT_ENHKEY_USAGE_PROP_ID: return "CERT_ENHKEY_USAGE_PROP_ID";
	case CERT_NEXT_UPDATE_LOCATION_PROP_ID: return "CERT_NEXT_UPDATE_LOCATION_PROP_ID";
	case CERT_FRIENDLY_NAME_PROP_ID: return "CERT_FRIENDLY_NAME_PROP_ID";
	case CERT_PVK_FILE_PROP_ID: return "CERT_PVK_FILE_PROP_ID";
	case CERT_DESCRIPTION_PROP_ID: return "CERT_DESCRIPTION_PROP_ID";
	case CERT_ACCESS_STATE_PROP_ID: return "CERT_ACCESS_STATE_PROP_ID";
	case CERT_SIGNATURE_HASH_PROP_ID: return "CERT_SIGNATURE_HASH_PROP_ID";
	case CERT_SMART_CARD_DATA_PROP_ID: return "CERT_SMART_CARD_DATA_PROP_ID";
	case CERT_EFS_PROP_ID: return "CERT_EFS_PROP_ID";
	case CERT_FORTEZZA_DATA_PROP_ID: return "CERT_FORTEZZA_DATA_PROP_ID";
	case CERT_ARCHIVED_PROP_ID: return "CERT_ARCHIVED_PROP_ID";
	case CERT_KEY_IDENTIFIER_PROP_ID: return "CERT_KEY_IDENTIFIER_PROP_ID";
	case CERT_AUTO_ENROLL_PROP_ID: return "CERT_AUTO_ENROLL_PROP_ID";
	case CERT_PUBKEY_ALG_PARA_PROP_ID: return "CERT_PUBKEY_ALG_PARA_PROP_ID";
	case CERT_CROSS_CERT_DIST_POINTS_PROP_ID: return "CERT_CROSS_CERT_DIST_POINTS_PROP_ID";
	case CERT_ISSUER_PUBLIC_KEY_MD5_HASH_PROP_ID: return "CERT_ISSUER_PUBLIC_KEY_MD5_HASH_PROP_ID";
	case CERT_SUBJECT_PUBLIC_KEY_MD5_HASH_PROP_ID: return "CERT_SUBJECT_PUBLIC_KEY_MD5_HASH_PROP_ID";
	case CERT_ENROLLMENT_PROP_ID: return "CERT_ENROLLMENT_PROP_ID";
	case CERT_DATE_STAMP_PROP_ID: return "CERT_DATE_STAMP_PROP_ID";
	case CERT_ISSUER_SERIAL_NUMBER_MD5_HASH_PROP_ID: return "CERT_ISSUER_SERIAL_NUMBER_MD5_HASH_PROP_ID";
	case CERT_SUBJECT_NAME_MD5_HASH_PROP_ID: return "CERT_SUBJECT_NAME_MD5_HASH_PROP_ID";
	case CERT_EXTENDED_ERROR_INFO_PROP_ID: return "CERT_EXTENDED_ERROR_INFO_PROP_ID";
	case CERT_RENEWAL_PROP_ID: return "CERT_RENEWAL_PROP_ID";
	case CERT_ARCHIVED_KEY_HASH_PROP_ID: return "CERT_ARCHIVED_KEY_HASH_PROP_ID";
	case CERT_AUTO_ENROLL_RETRY_PROP_ID: return "CERT_AUTO_ENROLL_RETRY_PROP_ID";
	case CERT_AIA_URL_RETRIEVED_PROP_ID: return "CERT_AIA_URL_RETRIEVED_PROP_ID";
	case CERT_AUTHORITY_INFO_ACCESS_PROP_ID: return "CERT_AUTHORITY_INFO_ACCESS_PROP_ID";
	case CERT_BACKED_UP_PROP_ID: return "CERT_BACKED_UP_PROP_ID";
	case CERT_OCSP_RESPONSE_PROP_ID: return "CERT_OCSP_RESPONSE_PROP_ID";
	case CERT_REQUEST_ORIGINATOR_PROP_ID: return "CERT_REQUEST_ORIGINATOR_PROP_ID";
	case CERT_SOURCE_LOCATION_PROP_ID: return "CERT_SOURCE_LOCATION_PROP_ID";
	case CERT_SOURCE_URL_PROP_ID: return "CERT_SOURCE_URL_PROP_ID";
	case CERT_NEW_KEY_PROP_ID: return "CERT_NEW_KEY_PROP_ID";
	case CERT_OCSP_CACHE_PREFIX_PROP_ID: return "CERT_OCSP_CACHE_PREFIX_PROP_ID";
	case CERT_SMART_CARD_ROOT_INFO_PROP_ID: return "CERT_SMART_CARD_ROOT_INFO_PROP_ID";
	case CERT_NO_AUTO_EXPIRE_CHECK_PROP_ID: return "CERT_NO_AUTO_EXPIRE_CHECK_PROP_ID";
	case CERT_NCRYPT_KEY_HANDLE_PROP_ID: return "CERT_NCRYPT_KEY_HANDLE_PROP_ID";
	case CERT_HCRYPTPROV_OR_NCRYPT_KEY_HANDLE_PROP_ID: return "CERT_HCRYPTPROV_OR_NCRYPT_KEY_HANDLE_PROP_ID";
	case CERT_SUBJECT_INFO_ACCESS_PROP_ID: return "CERT_SUBJECT_INFO_ACCESS_PROP_ID";
	case CERT_CA_OCSP_AUTHORITY_INFO_ACCESS_PROP_ID: return "CERT_CA_OCSP_AUTHORITY_INFO_ACCESS_PROP_ID";
	case CERT_CA_DISABLE_CRL_PROP_ID: return "CERT_CA_DISABLE_CRL_PROP_ID";
	case CERT_ROOT_PROGRAM_CERT_POLICIES_PROP_ID: return "CERT_ROOT_PROGRAM_CERT_POLICIES_PROP_ID";
	case CERT_ROOT_PROGRAM_NAME_CONSTRAINTS_PROP_ID: return "CERT_ROOT_PROGRAM_NAME_CONSTRAINTS_PROP_ID";
	case CERT_SUBJECT_OCSP_AUTHORITY_INFO_ACCESS_PROP_ID: return "CERT_SUBJECT_OCSP_AUTHORITY_INFO_ACCESS_PROP_ID";
	case CERT_SUBJECT_DISABLE_CRL_PROP_ID: return "CERT_SUBJECT_DISABLE_CRL_PROP_ID";
	case CERT_CEP_PROP_ID: return "CERT_CEP_PROP_ID";
	case CERT_SIGN_HASH_CNG_ALG_PROP_ID: return "CERT_SIGN_HASH_CNG_ALG_PROP_ID";
	case CERT_SCARD_PIN_ID_PROP_ID: return "CERT_SCARD_PIN_ID_PROP_ID";
	case CERT_SCARD_PIN_INFO_PROP_ID: return "CERT_SCARD_PIN_INFO_PROP_ID";
	case CERT_SUBJECT_PUB_KEY_BIT_LENGTH_PROP_ID: return "CERT_SUBJECT_PUB_KEY_BIT_LENGTH_PROP_ID";
	case CERT_PUB_KEY_CNG_ALG_BIT_LENGTH_PROP_ID: return "CERT_PUB_KEY_CNG_ALG_BIT_LENGTH_PROP_ID";
	case CERT_ISSUER_PUB_KEY_BIT_LENGTH_PROP_ID: return "CERT_ISSUER_PUB_KEY_BIT_LENGTH_PROP_ID";
	case CERT_ISSUER_CHAIN_SIGN_HASH_CNG_ALG_PROP_ID: return "CERT_ISSUER_CHAIN_SIGN_HASH_CNG_ALG_PROP_ID";
	case CERT_ISSUER_CHAIN_PUB_KEY_CNG_ALG_BIT_LENGTH_PROP_ID: return "CERT_ISSUER_CHAIN_PUB_KEY_CNG_ALG_BIT_LENGTH_PROP_I";
	case CERT_NO_EXPIRE_NOTIFICATION_PROP_ID: return "CERT_NO_EXPIRE_NOTIFICATION_PROP_ID";
	case CERT_AUTH_ROOT_SHA256_HASH_PROP_ID: return "CERT_AUTH_ROOT_SHA256_HASH_PROP_ID ";
	case CERT_NCRYPT_KEY_HANDLE_TRANSFER_PROP_ID: return "CERT_NCRYPT_KEY_HANDLE_TRANSFER_PROP_ID ";
	case CERT_HCRYPTPROV_TRANSFER_PROP_ID: return "CERT_HCRYPTPROV_TRANSFER_PROP_ID ";
	case CERT_SMART_CARD_READER_PROP_ID: return "CERT_SMART_CARD_READER_PROP_ID ";
	case CERT_SEND_AS_TRUSTED_ISSUER_PROP_ID: return "CERT_SEND_AS_TRUSTED_ISSUER_PROP_ID ";
	case CERT_KEY_REPAIR_ATTEMPTED_PROP_ID: return "CERT_KEY_REPAIR_ATTEMPTED_PROP_ID ";
	case CERT_DISALLOWED_FILETIME_PROP_ID: return "CERT_DISALLOWED_FILETIME_PROP_ID ";
	case CERT_ROOT_PROGRAM_CHAIN_POLICIES_PROP_ID: return "CERT_ROOT_PROGRAM_CHAIN_POLICIES_PROP_ID ";
	case CERT_SMART_CARD_READER_NON_REMOVABLE_PROP_ID: return "CERT_SMART_CARD_READER_NON_REMOVABLE_PROP_ID ";
	case CERT_SHA256_HASH_PROP_ID: return "CERT_SHA256_HASH_PROP_ID ";
	case CERT_SCEP_SERVER_CERTS_PROP_ID: return "CERT_SCEP_SERVER_CERTS_PROP_ID ";
	case CERT_SCEP_RA_SIGNATURE_CERT_PROP_ID: return "CERT_SCEP_RA_SIGNATURE_CERT_PROP_ID ";
	case CERT_SCEP_RA_ENCRYPTION_CERT_PROP_ID: return "CERT_SCEP_RA_ENCRYPTION_CERT_PROP_ID ";
	case CERT_SCEP_CA_CERT_PROP_ID: return "CERT_SCEP_CA_CERT_PROP_ID ";
	case CERT_SCEP_SIGNER_CERT_PROP_ID: return "CERT_SCEP_SIGNER_CERT_PROP_ID ";
	case CERT_SCEP_NONCE_PROP_ID: return "CERT_SCEP_NONCE_PROP_ID ";
	case CERT_SCEP_ENCRYPT_HASH_CNG_ALG_PROP_ID: return "CERT_SCEP_ENCRYPT_HASH_CNG_ALG_PROP_ID ";
	case CERT_SCEP_FLAGS_PROP_ID: return "CERT_SCEP_FLAGS_PROP_ID ";
	case CERT_SCEP_GUID_PROP_ID: return "CERT_SCEP_GUID_PROP_ID ";
	case CERT_SERIALIZABLE_KEY_CONTEXT_PROP_ID: return "CERT_SERIALIZABLE_KEY_CONTEXT_PROP_ID ";
	case CERT_ISOLATED_KEY_PROP_ID: return "CERT_ISOLATED_KEY_PROP_ID ";
	case CERT_SERIAL_CHAIN_PROP_ID: return "CERT_SERIAL_CHAIN_PROP_ID ";
	case CERT_KEY_CLASSIFICATION_PROP_ID: return "CERT_KEY_CLASSIFICATION_PROP_ID ";
	case CERT_OCSP_MUST_STAPLE_PROP_ID: return "CERT_OCSP_MUST_STAPLE_PROP_ID ";
	case CERT_DISALLOWED_ENHKEY_USAGE_PROP_ID: return "CERT_DISALLOWED_ENHKEY_USAGE_PROP_ID ";
	case CERT_NONCOMPLIANT_ROOT_URL_PROP_ID: return "CERT_NONCOMPLIANT_ROOT_URL_PROP_ID ";
	case CERT_PIN_SHA256_HASH_PROP_ID: return "CERT_PIN_SHA256_HASH_PROP_ID ";
	case CERT_CLR_DELETE_KEY_PROP_ID: return "CERT_CLR_DELETE_KEY_PROP_ID ";
	case CERT_NOT_BEFORE_FILETIME_PROP_ID: return "CERT_NOT_BEFORE_FILETIME_PROP_ID";
	case CERT_NOT_BEFORE_ENHKEY_USAGE_PROP_ID: return "CERT_NOT_BEFORE_ENHKEY_USAGE_PROP_ID";
	case CERT_FIRST_RESERVED_PROP_ID: return "CERT_FIRST_RESERVED_PROP_ID";
	case CERT_LAST_RESERVED_PROP_ID: return "CERT_LAST_RESERVED_PROP_ID";
	case CERT_FIRST_USER_PROP_ID: return "CERT_FIRST_USER_PROP_ID";
	case CERT_LAST_USER_PROP_ID: return "CERT_LAST_USER_PROP_ID";
